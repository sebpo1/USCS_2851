...
var Ad = {
        ...
        function searchMacros(item) {
            for (i = 1; i <= framesArray.data.frameCount; i++) {
                ...
                if (extractedMacros !== null) {
                    ...
                    //     console.log(itineraries[itinNum])
    ...
    legalClick: function() {
        ...
        Ad.byId("legalOverlayClose").addEventListener("click", function() {
            TweenLite.to(Ad.byId("legalOverlay"), carousel_speed, { top: adW + "px" });
        });
    ...
    overlayHover: function() {
        ...
        Ad.byId("medallionOverlayClose").addEventListener("click", function(el) {
            ...
            TweenLite.to(Ad.byId("medallionOverlay"), carousel_speed, { top: -adW + "px" });
        });
        TweenLite.to(Ad.byId("medallionOverlay"), carousel_speed, { top: 0 });
    },
    ...
    feedLoadError: function() {
        ...
        trace("Feed Load Failed. Initializing Feed Fail state...");
        ...
        var feedfailImage = document.createElement("div");
        feedfailImage.id = "feedfailImage";
        feedfailImage.classList.add("feedfailImage");
        document.body.appendChild(feedfailImage);
   

        var newBackupImage = new Image();
        newBackupImage.src = framesArray["data"]["failsafeImg"];
        feedfailImage.appendChild(newBackupImage);
        // console.log(newBackupImage);

        myFT.applyClickTag(document.getElementById("feedfailImage"), 1, framesArray["data"]["failsafeClickTag"]);
        TweenLite.to(Ad.byId("container"), carousel_speed, { display: 'none', delay: .5 });
        // TweenLite.to(Ad.byId("arrows"), carousel_speed, { display: 'none', delay: .5 });
        // TweenLite.to(Ad.byId("logo_img"), carousel_speed, { display: 'none', delay: .5 });
        // TweenLite.to(Ad.byId("logo2_img"), carousel_speed, { display: 'none', delay: .5 });
        // TweenLite.to(Ad.byId("cta"), carousel_speed, { display: 'none', delay: .5 });
        // TweenLite.to(Ad.byId("ctaSale"), carousel_speed, { display: 'none', delay: .5 });
        // TweenLite.to(Ad.byId("ctaLegal"), carousel_speed, { display: 'none', delay: .5 });
    },
    ...
    init: function() {
        ...
        framesArray["data"] = {
            ...
            ctaBorderHex: Ad.xySplitter(Ad.getIA('ctaBtnBorder_hex_hexHov')),
    ...
    build: function() {
        ...
        for (i = 1; i <= framesArray.data.frameCount; i++) {
            ...
            //frame 3 letter spacing added
            Ad.classInId("head", "f" + i).classList.add("letterspace")
        }
        ...
        Ad.byId("cta").style.border = '1px solid ' +  framesArray["data"]["ctaBorderHex"][0];
        ...
        if (framesArray["f1"]["medallionToggle"] == "on") {
            TweenLite.to(Ad.byId("cta"), 1, { opacity: 1, delay: .5 });
            // TweenLite.to(Ad.byId("ctaMedallion"), 1, { opacity: 1, delay: .5 });
        ...
        newLogoImg.style.position = "absolute";
        newLogoImg.style.left = framesArray["data"]["logoImgX"] + "px";
        newLogoImg.style.top = framesArray["data"]["logoImgY"] + "px";
        ...
        newLogo2Img.style.position = "absolute";
        newLogo2Img.style.left = framesArray["data"]["logo2ImgX"] + "px";
        newLogo2Img.style.top = framesArray["data"]["logo2ImgY"] + "px";
        ...
        container.addEventListener("mouseover", function() {
            ...
            cta.style.border = '1px solid ' + framesArray.data.ctaBorderHex[1];
        ...
        container.addEventListener("mouseout", function() {
            ...
            cta.style.border = '1px solid ' + framesArray.data.ctaBorderHex[0];
