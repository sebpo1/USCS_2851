...
//        runResize("head");
        runResize("subhead1","head");
        runResize("subhead2","head");

        function runResize(elem,elem2) {
            ...
            for (i = 1; i <= document.getElementsByClassName(elem).length; i++) {
                for (a = 0; a < document.getElementsByClassName(elem)[i - 1].getElementsByTagName("div").length; a++) {
                    ...
                    if (parseInt(document.getElementsByClassName(elem)[i - 1].getElementsByTagName("div")[a].offsetWidth) > parseInt(document.getElementsByClassName(elem)[i - 1].clientWidth)) {
                        ...
                        var headFontSize = parseInt(document.getElementsByClassName(elem2)[i - 1].getElementsByTagName("div")[a].style.fontSize);
                        console.log(headFontSize)
                        var newFontSize = startingFontSize;
                        do {
                            if(newFontSize == headFontSize) {
                               break;
                            } else {
                            ...
                            if (newFontSize == startingFontSize - 3 || newFontSize == headFontSize) {
    ...
    overlayHover: function() {
        ...
        Ad.byId("medallionOverlayClose").addEventListener("click", function(el) {
            ...
            TweenLite.to(Ad.byId("medallionOverlay"), carousel_speed, { bottom: -adH + "px" });
        });
    ...
    build: function() {
        ...
        Ad.byId("cta").style.border = '2px solid ' +  framesArray["data"]["ctaBorderHex"][0];
        ...
        newLogo2Img.classList.add("abso");
        ...
        container.addEventListener("mouseover", function() {
            ...
            cta.style.border = '2px solid ' + framesArray.data.ctaBorderHex[1];
        ...
        container.addEventListener("mouseout", function() {
            ...
            cta.style.border = '2px solid ' + framesArray.data.ctaBorderHex[0];
